            ...
            <div class="p-6 space-y-5">
                ...
                <div class="group">
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                        Tipo de Votação <span class="text-red-500">*</span>
                    </label>
                    <div class="grid grid-cols-2 gap-3">
                        <!-- Opção Nominal -->
                        <label
                            class="radio-option relative flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all"
                            data-type="nominal">
                            <input type="radio" name="tipo_votacao" value="nominal" checked class="sr-only peer">
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    ...
                                    <span class="font-bold text-gray-900 dark:text-white">Nominal</span>
                                </div>
                                <p class="text-xs text-gray-600 dark:text-gray-400">Mostra quem votou</p>
                            </div>
                            <!-- Indicador de Selecionado -->
                            <div
                                class="selection-indicator absolute top-3 right-3 w-6 h-6 rounded-full border-2 flex items-center justify-center">
                                <svg class="w-4 h-4 text-white check-icon" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                        ...
                        <label
                            class="radio-option relative flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all"
                            data-type="anonima">
                            <input type="radio" name="tipo_votacao" value="anonima" class="sr-only peer">
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    ...
                                    <span class="font-bold text-gray-900 dark:text-white">Anônima</span>
                                </div>
                                <p class="text-xs text-gray-600 dark:text-gray-400">Oculta identidade</p>
                            </div>
                            <!-- Indicador de Selecionado -->
                            <div
                                class="selection-indicator absolute top-3 right-3 w-6 h-6 rounded-full border-2 flex items-center justify-center">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-2 flex items-center gap-1">
                        ...
                        Votação anônima não exibe quem votou nos resultados
                    </p>
                </div>
                ...
                <style>
                    ...
                    /* Indicador padrão (não selecionado) */
                    .radio-option .selection-indicator {
                        border-color: #d1d5db;
                    ...
                    /* Estilo quando SELECIONADO - Nominal (Azul) */
                    .radio-option[data-type="nominal"]:has(input:checked) {
                        border-color: #3b82f6;
                        border-width: 3px;
                        background-color: #eff6ff;
                    }

                    .dark .radio-option[data-type="nominal"]:has(input:checked) {
                        background-color: #1e3a8a33;
                    }

                    .radio-option[data-type="nominal"]:has(input:checked) .selection-indicator {
                        border-color: #3b82f6;
                        background-color: #3b82f6;
                    }

                    .radio-option[data-type="nominal"]:has(input:checked) .check-icon {
                        opacity: 1;
                    }

                    /* Estilo quando SELECIONADO - Anônima (Roxo) */
                    .radio-option[data-type="anonima"]:has(input:checked) {
                        border-color: #a855f7;
                        border-width: 3px;
                        background-color: #faf5ff;
                    }

                    .dark .radio-option[data-type="anonima"]:has(input:checked) {
                        background-color: #581c8733;
                    }

                    .radio-option[data-type="anonima"]:has(input:checked) .selection-indicator {
                        border-color: #a855f7;
                        background-color: #a855f7;
                    }

                    .radio-option[data-type="anonima"]:has(input:checked) .check-icon {
                        opacity: 1;
                    }
