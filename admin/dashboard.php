        ...
        <form method="POST" action="">
            <div class="p-6 space-y-5">
                ...
                <div class="group">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="relative flex items-center p-4 border-2 border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20 rounded-xl cursor-pointer hover:border-blue-500 transition-all">
                        ...
                        <label class="relative flex items-center p-4 border-2 border-gray-200 dark:border-gray-600 rounded-xl cursor-pointer hover:border-purple-500 transition-all peer-checked:border-purple-500 peer-checked:bg-purple-50">
