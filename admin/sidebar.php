<aside class="hidden md:flex flex-col w-72 h-screen bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800 shadow-xl fixed top-0 left-0 z-50 transition-all duration-300">
    <div class="flex items-center h-24 px-8 border-b border-gray-100 dark:border-gray-800">
